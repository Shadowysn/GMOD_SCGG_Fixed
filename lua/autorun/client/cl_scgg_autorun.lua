...
local function HL2Options(panel) -- HL2 Options for the menu.
	...
	panel:AddControl("Toggle",{Label = "Affect Players",min = 0,max = 1,Command = "scgg_affect_players"})--5
	panel:ControlHelp("0 = Players will not be directly killed")
	panel:ControlHelp("1 = Players can be directly killed")
	
	panel:AddControl("Toggle",{Label = "Weapon Vaporization",min = 0,max = 1,Command = "scgg_weapon_vaporize"})--6
	panel:ControlHelp("0 = Disabled")
	panel:ControlHelp("1 = Dropped weapons will be vaporized map-wide")
	
	panel:AddControl("Toggle",{Label = "Extra Primary Attack Behavior",min = 0,max = 1,Command = "scgg_primary_extra"})--4
	--panel:ControlHelp("")
	panel:ControlHelp("0 = None")
	panel:ControlHelp("1 = Gatling primary fire with individual M1 spam, seen in HL2:EP1")
	
	panel:AddControl("Toggle",{Label = "Foreign Interaction",min = 0,max = 1,Command = "scgg_allow_others"})--7
	...
	panel:AddControl("Slider",{Label = "Armor Drain",min = 0,max = 2,Command = "scgg_keep_armor"})--8
	...
	panel:AddControl("Slider",{Label = "Claw Behavior",min = 0,max = 2,Command = "scgg_claw_mode"})--9
	panel:ControlHelp("0 = Claws always closed")
	panel:ControlHelp("1 = Claws always open")
	panel:ControlHelp("2 = Claws in dynamic state")
	
	panel:AddControl("Toggle",{Label = "Light Settings",min = 0,max = 1,Command = "scgg_light"})--10
	panel:ControlHelp("0 = The weapon will not emit a light")
	panel:ControlHelp("1 = The weapon will emit a light")
	
	panel:AddControl("Toggle",{Label = "Muzzle Flash Settings",min = 0,max = 1,Command = "scgg_muzzle_flash"})--11
	panel:ControlHelp("0 = The weapon will not emit a light")
	panel:ControlHelp("1 = The weapon will emit a light")
	
	panel:AddControl("Toggle",{Label = "Electrocute Victims",min = 0,max = 1,Command = "scgg_zap"})--12
	panel:ControlHelp("0 = The victim will not be electrocuted")
	panel:ControlHelp("1 = The victim will be electrocuted")
	
	panel:AddControl("Toggle",{Label = "Electrocuted Sounds",min = 0,max = 1,Command = "scgg_zap_sound"})--13
	panel:ControlHelp("0 = Electrocuted victims will not emit sounds")
	panel:ControlHelp("1 = Electrocuted victims will emit sounds")
	
	panel:AddControl("Toggle",{Label = "Deploy Behavior",min = 0,max = 1,Command = "scgg_deploy_style"})--14
	--panel:ControlHelp("")
	panel:ControlHelp("0 = HL2 speed")
	panel:ControlHelp("1 = GMOD speed (sv_defaultdeployspeed)")
	
	panel:AddControl("Toggle",{Label = "Visual Effects",min = 0,max = 1,Command = "scgg_no_effects"})--15
	...
	panel:AddControl("Toggle",{Label = "Equipping Sound",min = 0,max = 1,Command = "scgg_equip_sound"})--16
